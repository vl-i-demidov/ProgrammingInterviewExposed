...
{
    public class ListUnflatteningTests
    {
        private readonly ITestOutputHelper _output;

        public ListUnflatteningTests(ITestOutputHelper output)
        {
            _output = output;
        }

        [Fact]
        public void UnflattensRight()
        {
            ...
            var fl = new ListUnflattener();
            fl.FlattenList(n1l1, n3l1);

            PrintNode(n1l1);

            fl.UnflattenList(n1l1);

            PrintNode(n1l1);
        }


        private void PrintNode(Node head, bool printEnd = true)
        {
            var print = "";
            ...
            foreach (var pn in parents)
            {
                ...
                PrintNode(pn.Child, printEnd: false);
            }
